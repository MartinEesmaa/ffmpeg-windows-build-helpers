...
build_cmake() {
  download_and_unpack_file https://cmake.org/files/v3.14/cmake-3.14.5.tar.gz
  cd cmake-3.14.5
...
build_mbedtls() {
  ...
  mkdir -p mbedtls-mbedtls-2.16.2/build_dir
  cd mbedtls-mbedtls-2.16.2/build_dir # Out-of-source build.
